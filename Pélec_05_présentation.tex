...
\begin{frame}{\insertsection}
  ...
  -> Résultats [draw] // { Meilleur paramètre [grow=down] --[draw=none] Figure RMSE[align here] --[draw=none]
  Figure variable test vs variable prédite --[draw=none] "R² RMSE, MAE et temps de calcul"}
  };
