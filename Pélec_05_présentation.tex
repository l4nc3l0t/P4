...
\begin{frame}{\insertsection}
  ...
  \vspace{.5cm}
  \tikz [nodes={draw}]
  \graph [tree layout, level distance=4cm] {
  train test split [grow=right] ->
  {RobustScaler -> "Modèle.fit"} -> {"R², RMSE, MAE et temps de calcul",
  meilleur paramètre, "figure RMSE",
  figure variable test vs variable prédite};
  boucle [draw] // {RobustScaler, "Modèle.fit", "R², RMSE, MAE et temps de calcul",
  meilleur paramètre, "figure RMSE",
  figure variable test vs variable prédite};
  pipeline [draw] // {RobustScaler, "Modèle.fit"};
  };
