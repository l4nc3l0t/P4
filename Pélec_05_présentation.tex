...
\begin{frame}{\insertsection}
  ...
  \vspace{.5cm}
  \tikz [rounded corners]
  \graph [layered layout, grow=right, nodes={draw, font=\small}, head anchor=west, tail anchor=east,
  edges=rounded corners, sibling distance=5mm]{
  Jeu de données -> train test split  -> Cross Validation -> {Split 5, Split 4, Split 3, Split 2, Split 1}
  -> Pipeline [draw] // {RobustScaler -> "Modèle.fit"}, "Modèle.fit"
  -> {"R² RMSE, MAE et temps de calcul", Meilleur paramètre, Figure RMSE,
  Figure variable test vs variable prédite},
  "GridSearch"  [draw]  // {Cross Validation, Split 5, Split 4, Split 3, Split 2, Split 1, RobustScaler, "Modèle.fit"},
  Résultats [draw] // {"R² RMSE, MAE et temps de calcul", Meilleur paramètre, Figure RMSE,
  Figure variable test vs variable prédite}
  };
